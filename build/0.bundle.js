...
MemoryStatsWidget=function(_React$Component){_inherits(MemoryStatsWidget,_React$Component);

function MemoryStatsWidget(props){_classCallCheck(this,MemoryStatsWidget);var _this=_possibleConstructorReturn(this,(MemoryStatsWidget.__proto__||Object.getPrototypeOf(MemoryStatsWidget)).call(this,
props));

(0,_bindAll2.default)(_this,['componentDidMount','handleRefreshClick']);return _this;
}_createClass(MemoryStatsWidget,[{key:'componentDidMount',value:function componentDidMount()
...
}}]);return MemoryStatsWidget;}(_react2.default.Component);
;
...
(0,_reactRedux.connect)(mapStateToProps)(MemoryStatsWidget);
