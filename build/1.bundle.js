...
;(function (global, factory) {
    true ? factory(__webpack_require__(898)) :
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(1036)();
...
var color = __webpack_require__(1058);
...
var implementation = __webpack_require__(1049);
...
var moment = __webpack_require__(898);
...
/* MIT license */
var colorNames = __webpack_require__(1061);
...
/* MIT license */
var convert = __webpack_require__(1060);
var string = __webpack_require__(1057);
...
var conversions = __webpack_require__(1059);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(40), __webpack_require__(120)(module)))
...
var _chart = __webpack_require__(1015);
...
var _reactChartjs=__webpack_require__(1064);
...
CpuStatsWidget=function(_React$Component){_inherits(CpuStatsWidget,_React$Component);

function CpuStatsWidget(props){_classCallCheck(this,CpuStatsWidget);var _this=_possibleConstructorReturn(this,(CpuStatsWidget.__proto__||Object.getPrototypeOf(CpuStatsWidget)).call(this,
props));

(0,_bindAll2.default)(_this,['componentDidMount','handleRefreshClick']);return _this;
}_createClass(CpuStatsWidget,[{key:'componentDidMount',value:function componentDidMount()
...
var labels=[],data=[],colors=['#FFE7C5','#FFD69B','#FFC676','#DEA14B','#BF7F26'];
...
var cpuTotal=data.reduce(function(a,b){return a+b;},0);

return(
_react2.default.createElement(_Widget2.default,{lastUpdated:systemStats.lastUpdated,isFetching:systemStats.isFetching,handleRefreshClick:this.handleRefreshClick},
...
}}]);return CpuStatsWidget;}(_react2.default.Component);
;
...
(0,_reactRedux.connect)(mapStateToProps)(CpuStatsWidget);
